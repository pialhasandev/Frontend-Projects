...
const Header = () => {
  ...
  >
    ...
    <text
      ...
      fontWeight="700"
    >
      <tspan fill="url(#gradientSecondary)">Pial Hasan</tspan>
    </text>
  </svg>
</Link>
          ...
          <div className="hidden md:block">
            <ul className="flex items-center gap-x-6 lg:gap-x-10">
              ...
              <li><Link className="text-gray-400 hover:text-white transition" to="/about">About</Link></li>
              <li><Link className="text-gray-400 hover:text-white transition" to="/projects">Projects</Link></li>
        ...
        <div className="md:hidden mt-3  px-4 pb-5">
          <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-xl py-5">
            ...
            <ul className="flex flex-col gap-4 text-center">
              <li><Link onClick={() => setOpen(false)} className="text-gray-400 hover:text-white" to="/">Home</Link></li>
              <li><Link onClick={() => setOpen(false)} className="text-gray-400 hover:text-white" to="/about">About</Link></li>
              <li><Link onClick={() => setOpen(false)} className="text-gray-400 hover:text-white" to="/projects">Projects</Link></li>
              <li><Link onClick={() => setOpen(false)} className="text-gray-400 hover:text-white" to="/contact">Contact</Link></li>
            </ul>
