...
const Banner = () => {
  ...
  <div className="inline-flex items-center gap-2 px-4 py-1.5 sm:px-5 sm:py-2 rounded-full 
        ...
        <Flex className="flex-col lg:flex-row items-start justify-between gap-12">
          ...
          <div className="text-center lg:text-left max-w-xl">
            ...
            <h1 className="font-bold uppercase 
              ...
              Building digital{" "}
              <span className="gradient-secondary ">experiences</span> that matter.
            </h1>

            <p className=" text-primarty 
          ...
          >
            ...
            <pre className="text-[10px] sm:text-xs md:text-sm leading-5 pb-18 py-5 sm:leading-6 text-slate-200 whitespace-pre-wrap ml-10 overflow-x-auto">
              ...
              {"\n  "}
              role: <span className="text-green-400">'Front-End Developer'</span>,
              {"\n  "}
              location: <span className="text-green-400">'Azimpur, Dhaka, Bangladesh'</span>,
              {"\n  "}
              skills: [{"\n    "}
